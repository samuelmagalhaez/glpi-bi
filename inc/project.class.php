...
class Project extends CommonDBTM implements ExtraVisibilityCriteria {
   ...
   **/
   function showForm($ID, $options = []) {
      ...
      echo "<td>";
      if($ID == '' || !$ID){
         Html::autocompletionTextField($this, 'code', array('value'=> time(),'attrs'=>array('readonly'=>'readonly')));
      }
      else{
         Html::autocompletionTextField($this, 'code',array('attrs'=>array('readonly'=>'readonly')));
      }
      echo "</td>";
      echo "</tr>";
      echo "<tr class='tab_bg_1'>";
